  ...
  return [
    {
      ...
      submission: {
        ...
        text: `Synthetic fixture report: delay observed on ${context.lineId}.`,
        directionText: 'Towards terminal',
        effect: 'delay',
        delayMinutes: 8,
    ...
    },
    {
      ...
      submission: {
        ...
        lineIds: [context.lineId],
        stationIds: [context.stationId],
        text: `Synthetic fixture report: queue building on ${context.lineId}.`,
        directionText: 'Towards terminal',
        effect: 'delay',
        delayMinutes: 10,
        isStillHappening: true,
    ...
    },
    {
      ...
      submission: {
        ...
        lineIds: [context.lineId],
        stationIds: [context.stationId],
        text: `Synthetic fixture report: trains still delayed on ${context.lineId}.`,
        directionText: 'Towards terminal',
        effect: 'delay',
        delayMinutes: 12,
        isStillHappening: true,
    ...
    },
    {
      ...
      submission: {
        ...
        text: `Synthetic fixture report: train skipped stops on ${context.rangeLineId}.`,
    ...
    },
    {
      ...
      submission: {
        ...
        lineIds: [context.rangeLineId],
        stationIds: context.rangeStationIds,
        text: `Synthetic fixture report: no service between selected stops on ${context.rangeLineId}.`,
        directionText: 'Not sure',
        effect: 'no-service',
        isStillHappening: true,
      },
