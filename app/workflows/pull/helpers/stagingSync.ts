    ...
    return [
      {
        ...
        platform_door_count: l.platformDoorCount,
        train_car_counts: l.trainCarCounts,
      ...
      for (const row of full) {
        await tx
          ...
          .values({
            ...
            platform_door_count: row.platform_door_count,
            train_car_counts: row.train_car_counts,
