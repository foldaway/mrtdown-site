...
import type { ComponentManifest, IssueRef, IssueType } from '~/types';
          ...
          <div className="relative px-6 py-8 md:px-8 md:py-10">
            ...
            <div className="relative flex items-start gap-4 md:items-center">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="font-black text-3xl text-white leading-tight md:text-4xl">
                  <FormattedMessage
                    id="general.line_status.heading"
                    defaultMessage="{lineTitle} Service Status & Disruptions (Live)"
                    values={{
                      lineTitle:
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  <span className="font-semibold text-base text-gray-300">
                    <FormattedMessage
                      id="general.line_status.subheading"
