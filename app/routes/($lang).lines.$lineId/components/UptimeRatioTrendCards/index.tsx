  ...
  return (
    <div className="flex flex-col rounded-lg border border-gray-300 p-6 text-gray-800 shadow-lg md:col-span-12 lg:col-span-8 dark:border-gray-700 dark:text-gray-200">
      <span className="font-semibold text-gray-600 text-sm dark:text-gray-300">
        <FormattedMessage
          id="general.reliability_trend_past_period"
          defaultMessage="Reliability trend (past {period})"
          values={{
            period: (
              <FormattedNumber
                value={
      ...
      <div className="mt-4 flex items-center self-start">
        <span className="mr-3 font-medium text-gray-700 text-sm dark:text-gray-300">
          <FormattedMessage
            id="general.time_period"
            defaultMessage="Time period:"
          />
        </span>
        <div className="flex items-center divide-x divide-gray-300 rounded-md border border-gray-300 dark:divide-gray-600 dark:border-gray-600">
