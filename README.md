...
The generated MRTDown API client remains in the repo for shared types and
compatibility boundaries. New server-side reads should prefer the DB-backed
query layer.
...
- `app/client/**`: generated by `npm run api:client:generate`.
