/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39f2df12eae099aa9b7b4466fe60bd80)
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		PUBLIC_HOLIDAYS_WORKFLOW: Workflow<Parameters<import("./app/server").PublicHolidaysWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TIER" | "VITE_ROOT_URL" | "MRTDOWN_DATA_URL" | "CROWD_REPORT_DISPATCH_GITHUB_OWNER" | "CROWD_REPORT_DISPATCH_GITHUB_REPO" | "CROWD_REPORT_DISPATCH_GITHUB_EVENT_TYPE" | "CROWD_REPORT_DISPATCH_LIMIT" | "SENTRY_DSN" | "INTERNAL_API_TOKENS" | "CROWD_REPORT_DISPATCH_GITHUB_TOKEN">> {}
}
